        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div role="form">
                            <input type="hidden" name="usuario_id" value="<?= $cliente['usuario_id'] ?>">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="form-control" name="email" value="<?= $cliente['email'] ?>" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>CNPJ</label>
                                    <input value="<?= $cliente['cnpj'] ?>" type="text" name="cnpj" class="form-control"  onkeypress="mascara(this, '##.###.###/####-##')" placeholder="11.111.111/1111-11" maxlength="18">
                                </div>
                            </div>
                        </div>
                    </div>
